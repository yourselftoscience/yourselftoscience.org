        ...
        <div className="min-h-screen bg-slate-50">
            <section className="bg-white border-b border-slate-200 relative">
                ...
                <div className="max-w-5xl mx-auto px-4 py-6 md:py-20 text-center relative z-10">
                    <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-600 drop-shadow-sm mb-4 md:mb-8 tracking-tight leading-tight pb-2">
            ...
            <section className="max-w-6xl mx-auto px-4 py-8">
                {sortedFilteredResources.length > 0 ? (
                    <>
                        ...
                        <div className="mb-6 mt-2 w-full max-w-3xl mx-auto px-4">
                            <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 py-8 px-5 md:py-10 md:px-8 shadow-[0_8px_30px_rgb(37,99,235,0.2)] rounded-3xl relative overflow-hidden border border-blue-500/30">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-sm md:text-base text-blue-100 mb-6 max-w-xl mx-auto text-center leading-relaxed font-medium">
                                        New opportunities are added constantly to our catalogue. Join our newsletter to receive the latest scientific research projects directly to your inbox.
                                    </p>
                                    <NewsletterSignup />
                                </div>
                            </div>
